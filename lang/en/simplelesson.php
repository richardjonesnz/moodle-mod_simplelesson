...
$string['allowreports'] = 'Allow student to review all attempts';
$string['allowreports_help'] = 'Students cannot review previous attempts by default.  Check this box to allow via reports tab.';
