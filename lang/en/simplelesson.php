...
$string['add_question_help'] = 'Select one question to add to the page, the question type is shown in brackets.  Use the Preview question link to view and test the question as it will appear on the page.  Set a score as required. Questions which have already been added to the Simplelesson are disabled. To cancel, use the back button or Submit with no question selected (in any case you can easily delete a question from a page).';
...
$string['page_editing'] = 'Use this page to organize your Simple lesson pages (if any). You can add, edit, view, delete and move pages from here (use the icons under Actions).  Autosequencing will put the next and previous sequence numbers into a logical order. Click the Question number to preview the question (or add to add one). Remove to remove a question. Use the Manage Questions button to select the behaviour and category of questions that can be added to pages.  Add a question bank category if neccessary.';
